...
> **Reflects v2.235.0.** The version stamp, the template count and every
...
survivable. One-hundred-thirty-two suites, **4397 assertions**, all green at the current commit:
