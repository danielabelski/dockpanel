...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 830 HTTP routes. 147 app templates. 4397 regression assertions. ~49MB binaries. Zero subscriptions.
</p>
