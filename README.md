...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 829 HTTP routes. 147 app templates. 4322 regression assertions. ~49MB binaries. Zero subscriptions.
</p>
