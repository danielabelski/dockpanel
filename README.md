...
<p align="center">
  ...
  Self-hosted. Docker-native. Written in Rust. Panel services run on <strong>~49MB of RAM</strong>. 833 HTTP routes. 147 app templates. 4457 regression assertions. ~51MB binaries. Zero subscriptions.
</p>
